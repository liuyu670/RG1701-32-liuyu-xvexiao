...
<body onload="showtime()" background="../../image/back_05.jpg">
<div class="b">
    <span id="clock" style="color:#0000FF"></span>
</div>
<h1>欢迎登录</h1>
<div class="wrap">
    <img src="../../image/logo1.png" alt=""> <span><strong>选课管理系统</strong>
		</span>
</div>
<h2>当前登录：${admin.nickname } ${student.username } ${teacher.username}</h2><!--没有admin的时候就会显示student-->
